...
public class PruebaContenedor {
	public static void main(String[] args) {
		...
		try {
			escritura=new FileWriter("salida1.txt");
			escritura.write("Practica 1 Desarrollo de un contenedor lineal con una lista encadenada\n\n ######## Pruebas con ficheros #####\n Tiempos promedios en milisegundos por cada 1000 operaciones\n");
	...
	// Compruba el correcto funcionamiento de todas las operaciones de ContenedorDeEnteros
